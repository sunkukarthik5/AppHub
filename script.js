...
const defaultIcons = [
  "fas fa-globe", "fas fa-star", "fas fa-heart", "fas fa-home", "fas fa-briefcase", 
  "fas fa-envelope", "fas fa-photo-video", "fas fa-shopping-bag", "fas fa-music", 
  "fas fa-film", "fas fa-gamepad", "fas fa-book", "fas fa-newspaper", "fas fa-plane", 
  "fas fa-car", "fas fa-train", "fas fa-bus", "fas fa-bicycle", "fas fa-walking", 
  "fas fa-utensils", "fas fa-coffee", "fas fa-pizza-slice", "fas fa-hamburger", 
  "fas fa-ice-cream", "fas fa-cocktail", "fas fa-wine-glass-alt", "fas fa-beer", 
  "fas fa-shield-alt", "fas fa-lock", "fas fa-key", "fas fa-unlock", "fas fa-bell", 
  "fas fa-calendar", "fas fa-clock", "fas fa-stopwatch", "fas fa-hourglass", 
  "fas fa-flag", "fas fa-map", "fas fa-map-marker-alt", "fas fa-compass", 
  "fas fa-mountain", "fas fa-umbrella-beach", "fas fa-sun", "fas fa-moon", 
  "fas fa-cloud", "fas fa-cloud-sun", "fas fa-cloud-rain", "fas fa-snowflake", 
  "fas fa-wind", "fas fa-bolt", "fas fa-fire", "fas fa-water", "fas fa-seedling", 
  "fas fa-tree", "fas fa-feather", "fas fa-paw", "fas fa-dog", "fas fa-cat", 
  "fas fa-dove", "fas fa-fish", "fas fa-dragon", "fas fa-otter", "fas fa-hippo", 
  "fas fa-horse", "fas fa-frog", "fas fa-kiwi-bird", "fas fa-crow", "fas fa-spider", 
  "fas fa-mosquito", "fas fa-bug", "fas fa-leaf", "fas fa-apple-alt", "fas fa-lemon", 
  "fas fa-pepper-hot", "fas fa-carrot", "fas fa-cheese", "fas fa-egg", "fas fa-bacon", 
  "fas fa-drumstick-bite", "fas fa-fish-fins", "fas fa-cookie", "fas fa-birthday-cake", 
  "fas fa-candy-cane", "fas fa-ice-cream", "fas fa-lollipop", "fas fa-mug-hot", 
  "fas fa-blender", "fas fa-utensil-spoon", "fas fa-utensils", "fas fa-mortar-pestle", 
  "fas fa-hat-chef", "fas fa-store", "fas fa-shopping-cart", "fas fa-gift", 
  "fas fa-tag", "fas fa-receipt", "fas fa-credit-card", "fas fa-money-bill", 
  "fas fa-coins", "fas fa-piggy-bank", "fas fa-wallet", "fas fa-chart-line", 
  "fas fa-chart-bar", "fas fa-chart-pie", "fas fa-chart-area", "fas fa-calculator", 
  "fas fa-percentage", "fas fa-sort-amount-down", "fas fa-sort-amount-up", 
  "fas fa-filter", "fas fa-search", "fas fa-search-dollar", "fas fa-search-location", 
  "fas fa-microscope", "fas fa-flask", "fas fa-dna", "fas fa-atom", "fas fa-rocket", 
  "fas fa-satellite", "fas fa-satellite-dish", "fas fa-robot", "fas fa-microchip", 
  "fas fa-memory", "fas fa-server", "fas fa-database", "fas fa-hdd", "fas fa-save", 
  "fas fa-upload", "fas fa-download", "fas fa-network-wired", "fas fa-wifi", 
  "fas fa-bluetooth", "fas fa-bluetooth-b", "fas fa-signal", "fas fa-broadcast-tower", 
  "fas fa-tv", "fas fa-radio", "fas fa-camera", "fas fa-camera-retro", "fas fa-film", 
  "fas fa-video", "fas fa-photo-film", "fas fa-clapperboard", "fas fa-music", 
  "fas fa-headphones", "fas fa-headphones-alt", "fas fa-volume-up", "fas fa-volume-down", 
  "fas fa-volume-mute", "fas fa-volume-off", "fas fa-assistive-listening-systems", 
  "fas fa-phone", "fas fa-phone-alt", "fas fa-mobile-alt", "fas fa-tablet-alt", 
  "fas fa-laptop", "fas fa-desktop", "fas fa-tv", "fas fa-print", "fas fa-keyboard", 
  "fas fa-mouse", "fas fa-gamepad", "fas fa-vr-cardboard", "fas fa-compact-disc", 
  "fas fa-sd-card", "fas fa-usb", "fas fa-plug", "fas fa-battery-full", 
  "fas fa-battery-three-quarters", "fas fa-battery-half", "fas fa-battery-quarter", 
  "fas fa-battery-empty", "fas fa-power-off", "fas fa-solar-panel", "fas fa-wind", 
  "fas fa-water", "fas fa-fire", "fas fa-seedling", "fas fa-recycle", "fas fa-trash", 
  "fas fa-trash-alt", "fas fa-trash-restore", "fas fa-trash-restore-alt", 
  "fas fa-dumpster", "fas fa-dumpster-fire", "fas fa-box", "fas fa-box-open", 
  "fas fa-archive", "fas fa-pallet", "fas fa-truck", "fas fa-shipping-fast", 
  "fas fa-ship", "fas fa-plane", "fas fa-helicopter", "fas fa-car", "fas fa-motorcycle", 
  "fas fa-bus", "fas fa-bus-alt", "fas fa-train", "fas fa-subway", "fas fa-bicycle", 
  "fas fa-walking", "fas fa-hiking", "fas fa-running", "fas fa-skating", 
  "fas fa-skiing", "fas fa-skiing-nordic", "fas fa-snowboarding", "fas fa-swimmer", 
  "fas fa-surfing", "fas fa-sailing", "fas fa-horse", "fas fa-horse-head", 
  "fas fa-paw", "fas fa-dog", "fas fa-cat", "fas fa-crow", "fas fa-dove", 
  "fas fa-dragon", "fas fa-feather", "fas fa-feather-alt", "fas fa-fish", 
  "fas fa-frog", "fas fa-hippo", "fas fa-kiwi-bird", "fas fa-otter", "fas fa-spider"
];
...
// ✅ FIXED logout function - Only clears session, preserves user data
function logout() {
  if (confirm('Are you sure you want to logout?')) {
    // Only clear session data, NOT user data
    // This preserves user's apps, categories, profile, and theme
    localStorage.removeItem('apphub-current-user');
...
function setupEventListeners() {
  ...
  // ✅ FIXED: Added null checks for logout buttons
  if (navLogoutBtn) {
